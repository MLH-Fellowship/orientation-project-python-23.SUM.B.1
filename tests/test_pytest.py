...
def test_add_experience():
    ...
    Summary
    -------
    makes request to add a new experience and checks if the received payload have all required fields with valid formats
    """
...
def test_edit_experience():
    ...
    assert (
        response.json["message"] == "Experience with id 1 has been successfully updated"
    )
...
def test_delete_experience():
    ...
    assert (
        response.json["message"] == "Experience with id 1 has been successfully deleted"
    )
...
def test_edit_education():
    ...
    assert result == "Error: Not correct education index"
...
def test_delete_skill():
    ...
    new_skill = {"name": "Python", "proficiency": "82%", "logo": "example-logo.png"}
